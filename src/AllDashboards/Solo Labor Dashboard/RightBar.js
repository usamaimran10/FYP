...
const RightBar = (props) => {
  const gotoUpdateLabor = () => {
    window.location.href = "/updateSoloLaborProfile";
  };
  ...
  return (
    <div>
      ...
      >
        ...
        <div
          style={{ marginTop: "20px", cursor: "pointer", fontSize: "1.8REM" }}
        >
          <ul>
            <li onClick={gotoUpdateLabor}>Edit</li>
            <li>Contact</li>
            <li onClick={gotoLandingPage}>Log Out</li>
          </ul>
        </div>
      </div>
